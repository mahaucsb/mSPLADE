...
class SentenceTransformerA(SentenceTransformer):
    ...
    def fit(self,
        ...
        print("num train objectives:", num_train_objectives)
        ...
        for epoch in trange(epochs, desc="Epoch", disable=not show_progress_bar):
            ...
            for train_idx in range(num_train_objectives):
                ...
                if use_amp:
                    with autocast():
                        loss_value, neg_loss, pos_loss = loss_model(features, labels)
                    ...
                    loss_value, neg_loss, pos_loss = loss_model(features, labels)/accum_iter
                    loss_value.backward()
                    torch.nn.utils.clip_grad_norm_(loss_model.parameters(), max_grad_norm)
                ...
                neg_loss_accum += neg_loss
                pos_loss_accum += pos_loss
            ...
            if (epoch + 1) % accum_iter == 0:    
                ...
                if save_loss:
                    ...
                    writer.writerow([global_step, epoch, loss_accum.tolist(), neg_loss_accum.tolist(), pos_loss_accum.tolist()])
                    ft.flush()
                    loss_accum = 0
                    neg_loss_accum = 0 
                    pos_loss_accum = 0
